...
export default function ForHusleverandorerPage() {
  return (
    <>
      <HeroSection />
      <Problemet />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-6">
            Husmodellen din
            <br />
            <span className="text-green-400">på en ekte tomt til salgs</span>
          </h1>

          <p className="text-lg text-brand-400 leading-relaxed mb-10 max-w-xl">
            Kjøpere ser husmodellen din plassert på en konkret tomt – med pris, kalkyle og byggemuligheter. Ikke i en katalog, men på tomten de faktisk vurderer å kjøpe. Selger og kjøper ser det samme: ditt hus, på denne tomten, til denne prisen.
          </p>
    ...
    <section className="bg-white py-20 lg:py-28">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-brand-600 leading-relaxed">
          Dere bruker hundretusener på markedsføring, men treffer tusenvis som bare drømmesveiper. De som faktisk har kjøpt tomt og er klare til å bestille hus – de finner dere på Tomtly. Her ser de husmodellen deres plassert på tomten de vurderer, med komplett kalkyle.
        </p>
      </div>
    </section>
  )
  ...
  return (
    <section className="bg-brand-50 py-20 lg:py-28">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg text-brand-600 leading-relaxed">
          Hver tomt på Tomtly presenteres med husmodeller som passer tomtens regulering, størrelse og topografi. Kjøperen ser husmodellen deres med fasadebilde, plantegninger, inkludert-liste og komplett kostnadsoverslag – alt tilpasset den aktuelle tomten. De trenger ikke forestille seg noe. De ser det.
        </p>
      </div>
    </section>
  )
...
function HvaViGjor() {
  const punkter = [
    {
      ikon: FileText,
      tittel: 'Vi tegner opp alle husene og hyttene deres i 3D',
      beskrivelse: 'Send oss tegninger og huspriser. Vi modellerer husene og hyttene slik at de kan plasseres på enhver tomt. Digitalisering av boligene og prisene dine – ikke bare i katalog.',
    },
    {
      ikon: Target,
    ...
    },
    {
      ...
      beskrivelse: 'Ikke en generisk annonse. Kjøperen ser nøyaktig hvordan huset deres ser ut på den tomten de vurderer.',
    },
    {
      ikon: Zap,
      tittel: 'Leadet er deres – vi tar ingenting av salget',
      beskrivelse: 'Når en kjøper velger deres husmodell, mottar dere et kvalifisert lead med all tomteinfo.',
    },
  ]
    ...
    <section className="bg-brand-50 py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-brand-600">Velg nivået som passer deres ambisjon.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          <div className="bg-white rounded-2xl p-7 border-2 border-tomtly-accent text-center relative">
            ...
            <p className="text-sm font-medium text-brand-500 mb-2">Provisjonsmodell</p>
            <p className="text-3xl font-bold text-tomtly-dark mb-1">2 % + mva</p>
            <p className="text-sm text-brand-500 mb-4">av hussalg fra Tomtly-leads</p>
            <ul className="space-y-2 text-left mb-4">
              {[
                'Ingen månedlig kostnad',
                'Husmodeller på alle Tomtly-tomter',
                'Du betaler kun når leadet blir et salg',
                'Leads med kontaktinfo og tomteanalyse',
                'Månedlig rapport over leads',
              ].map((f) => (
            ...
            <p className="text-xs text-brand-400">Risikofritt — du betaler kun ved resultat</p>
          </div>
          <div className="bg-white rounded-2xl p-7 border border-brand-200 text-center">
            <p className="text-sm font-medium text-brand-500 mb-2">Abonnement</p>
            <p className="text-3xl font-bold text-tomtly-dark mb-1">10 000–20 000 kr</p>
            <p className="text-sm text-brand-500 mb-4">per måned · eks. mva</p>
            <ul className="space-y-2 text-left mb-4">
              {[
                'Husmodeller på alle Tomtly-tomter',
                'Prioritert plassering og eksponering',
                'Leads med kontaktinfo',
                'Dedikert kontaktperson',
                'Ingen provisjon per salg',
              ].map((f) => (
                <li key={f} className="flex items-start gap-2 text-sm text-brand-600">
                  <CheckCircle2 className="w-4 h-4 text-tomtly-accent flex-shrink-0 mt-0.5" />
                  {f}
            ...
            <p className="text-xs text-brand-400">Forutsigbar kostnad, ubegrenset leads</p>
          </div>
        </div>
      </div>
    </section>
...
function KomIGang() {
  const steg = [
    {
      nummer: '01',
      tittel: 'Send oss husmodeller og hyttemodeller',
      beskrivelse: 'Send tegninger, plantegninger og priser for modellene dere vil ha på plattformen.',
    },
    {
      nummer: '02',
      tittel: 'Vi tegner dem opp i 3D',
      beskrivelse: 'Vi modellerer husene og hyttene slik at de kan plasseres og visualiseres på enhver tomt.',
    },
    {
      nummer: '03',
      tittel: 'Modellene vises på matchende tomter',
      beskrivelse: 'Husmodellene presenteres automatisk i mulighetsstudier for tomter der de passer – basert på regulering, størrelse og prisklasse.',
    },
    {
      nummer: '04',
      tittel: 'Dere mottar kvalifiserte leads',
      beskrivelse: 'Når en kjøper velger deres husmodell, får dere et lead med komplett tomteinfo og kontaktdetaljer.',
    },
  ]
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-forest-50 rounded-2xl border-2 border-tomtly-accent p-10">
          ...
          <h2 className="font-display text-2xl lg:text-3xl font-bold text-tomtly-dark mb-4">
            En hus- eller hyttekontrakt er verdt 3-5 MNOK
          </h2>
          <p className="text-brand-600 leading-relaxed">
            Vi leverer leads som allerede har sett huset eller hytten deres på en konkret tomt med ferdig kalkyle. Disse er ikke drømmere – de har tomt, de har sett prisen, og de er klare til å ta en beslutning.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-brand-400">
            Send oss en henvendelse, så tar vi kontakt for å diskutere samarbeid.
          </p>
        </div>
        ...
        {sendt ? (
          ...
          >
            ...
            <div>
              <label className="block text-sm font-medium text-brand-700 mb-1.5">Antall husmodeller / hyttemodeller</label>
            ...
            <div>
              ...
              <textarea
                rows={3}
                placeholder="Fortell litt om selskapet og husmodellene/hyttemodellene deres..."
