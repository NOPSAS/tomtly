...
const TOMT = {
  ...
  nabolag: {
    ...
    punkter: [
      { kategori: 'Kollektivtransport', navn: 'Buss til Tangen/Oslo', avstand_m: 400, gangminutter: 1 },
      { kategori: 'Skole', navn: 'Bjørnemyr skole', avstand_m: 600, gangminutter: 1 },
      { kategori: 'Barnehage', navn: 'Bjørnemyr barnehage', avstand_m: 350, gangminutter: 1 },
      { kategori: 'Dagligvare', navn: 'Dagligvare Bjørnemyr', avstand_m: 500, gangminutter: 1 },
