...
const TOMT = {
  ...
  areal_m2: 605,
  gnr: 1, bnr: 1011,
  senterpunkt: { lat: 59.8346, lng: 10.6419 },

  tomtescore: {
    total: 84,
    delscorer: { beliggenhet: 82, regulering: 80, topografi: 92, infrastruktur: 85, marked: 88, okonomi: 78 },
    beregnet_dato: '2026-03-18',
    forklaring: 'Tomten scorer 84 av 100. Flat tomt, lett å bygge. Sterk etterspørsel på Nesodden. Godkjent fradeling og komplett dokumentasjon. 4 husmodeller med totalbudsjett 7,9–9,4 MNOK.',
  },
  ...
  regulering: {
    ...
    hensynssoner: [],
    bestemmelser: ['Maks BYA 20% (121,0 m²)', 'Maks gesimshøyde 7m, mønehøyde 9m', 'Godkjent delesøknad og matrikkelbrev', 'VA-søknad, overvannsrapport og avkjøringstillatelse utarbeidet'],
  ...
  risikoanalyse: {
    ...
    faktorer: [
      { kategori: 'Regulering', beskrivelse: 'Godkjent fradeling, innenfor plan', sannsynlighet: 1 as const, konsekvens: 2 as const, risikoverdi: 2, tiltak: 'Delesøknad allerede godkjent' },
      { kategori: 'Grunnforhold', beskrivelse: 'Flat tomt, kjente forhold', sannsynlighet: 1 as const, konsekvens: 2 as const, risikoverdi: 2, tiltak: 'Tilbud på grunnarbeid innhentet' },
    ...
    anbefalinger: ['Svært lav risiko – godkjent fradeling, fastpriser og kjente kostnader', 'Fra kjøp til nøkkel på under ett år'],
  },
  ...
  nabolag: {
    ...
    punkter: [
      { kategori: 'Kollektivtransport', navn: 'Buss til Tangen/Oslo', avstand_m: 400, gangminutter: 5 },
      { kategori: 'Skole', navn: 'Bjørnemyr skole', avstand_m: 600, gangminutter: 7 },
      { kategori: 'Barnehage', navn: 'Bjørnemyr barnehage', avstand_m: 350, gangminutter: 4 },
      { kategori: 'Dagligvare', navn: 'Dagligvare Bjørnemyr', avstand_m: 500, gangminutter: 6 },
      { kategori: 'Park/friområde', navn: 'Skog og turområder', avstand_m: 100, gangminutter: 1 },
    ],
  },

  dokumenter: [
    { navn: 'E-takst – Parsell B', url: '/documents/bjornemyrveien/etakst-parsell-b.pdf' },
    { navn: 'Kart – Parsell B', url: '/documents/bjornemyrveien/parsell-b-kart.pdf' },
    { navn: 'Kart – Parsell B (revidert)', url: '/documents/bjornemyrveien/parsell-b-kart-revidert.pdf' },
    { navn: 'Ny bolig – Parsell B', url: '/documents/bjornemyrveien/parsell-b-ny-bolig.pdf' },
    { navn: 'VA-tilkobling – Parsell B', url: '/documents/bjornemyrveien/va-tilkobling-parsell-b.pdf' },
    { navn: 'Overvannsrapport', url: '/documents/bjornemyrveien/overvannsrapport.pdf' },
    { navn: 'Tilbud – Tomt B', url: '/documents/bjornemyrveien/tilbud-tomt-b.pdf' },
...
export default function Bjornemyrveien20() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-36 space-y-6">
              ...
              <TomtKontakt />
              <TomtDeling adresse={TOMT.adresse} tomteId="bjornemyrveien-20" />
            </div>
          </div>
        </div>
      </div>
