...
const HUSMODELLER = [
  ...
  {
    id: 'nordstrand', navn: 'Nordstrand', leverandor: 'ABChus',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-16">
            ...
            <section id="husmodeller"><TomtHusmodeller modeller={HUSMODELLER} tomtType="skra" tomtNavn="Tomt C (skrå tomt)" /></section>
