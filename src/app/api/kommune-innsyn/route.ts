...
const INNSYN_KILDER: Record<string, InnsynKilde[]> = {
  ...
  '1112': [einnsynGeneric('Lund')],
  '1114': [einnsynGeneric('Bjerkreim')],
  '1119': [einnsynGeneric('Hå')],
  '1120': [p360('Klepp', 'klepp')],
  '1121': [einnsynGeneric('Time')],
  '1122': [p360('Gjesdal', 'gjesdal')],
  '1124': [elements('Sola', 'https://prod01.elementscloud.no/Publikum/964966931')],
  '1127': [p360('Randaberg', 'randaberg')],
  '1128': [einnsynGeneric('Kvitsøy')],
  '1130': [einnsynGeneric('Strand')],
  '1133': [einnsynGeneric('Hjelmeland')],
  '1134': [einnsynGeneric('Suldal')],
  '1135': [einnsynGeneric('Sauda')],
  '1144': [einnsynGeneric('Kvitsøy')],
  '1145': [einnsynGeneric('Bokn')],
  '1146': [einnsynGeneric('Tysvær')],
  '1149': [acos('Karmøy', 'karmoy')],
  '1151': [einnsynGeneric('Utsira')],
  '1160': [einnsynGeneric('Vindafjord')],

  // ══════════════════════════════════════════════════════════════
  // VESTLAND
  // ══════════════════════════════════════════════════════════════
  '4601': [einnsyn('Bergen', 'a9cd8dff-4b67-42d8-8ab7-a47e1bd09b5f')],
  '4602': [einnsynGeneric('Kinn')],
  '4611': [elements('Bømlo', 'https://prod01.elementscloud.no/publikum/834210622')],
  '4612': [einnsynGeneric('Fitjar')],
  '4613': [elements('Stord', 'https://prod01.elementscloud.no/publikum/939866914')],
  '4614': [einnsynGeneric('Sveio')],
  '4616': [einnsynGeneric('Kvam')],
  '4617': [elements('Kvinnherad', 'https://prod01.elementscloud.no/publikum/964967636')],
  '4618': [einnsynGeneric('Etne')],
  '4619': [einnsynGeneric('Samnanger')],
  '4620': [einnsynGeneric('Tysnes')],
  '4621': [elementsGnr('Voss', 'https://innsyn.voss.kommune.no')],
  '4622': [einnsynGeneric('Ullensvang')],
  '4623': [einnsynGeneric('Eidfjord')],
  '4624': [einnsynGeneric('Bjørnafjorden')],
  '4625': [einnsynGeneric('Austevoll')],
  '4626': [einnsynGeneric('Øygarden')],
  '4627': [acos('Askøy', 'askoy')],
  '4628': [einnsynGeneric('Fedje')],
  '4630': [einnsynGeneric('Osterøy')],
  '4631': [elements('Alver', 'https://prod02.elementscloud.no/publikum/920290922_prod-920290922')],
  '4632': [einnsynGeneric('Modalen')],
  '4633': [einnsynGeneric('Vaksdal')],
  '4634': [einnsynGeneric('Masfjorden')],
  '4635': [einnsynGeneric('Gulen')],
  '4636': [einnsynGeneric('Solund')],
  '4637': [einnsynGeneric('Hyllestad')],
  '4638': [einnsynGeneric('Høyanger')],
  '4639': [einnsynGeneric('Vik')],
  '4640': [elements('Sogndal', 'https://prod01.elementscloud.no/publikum/922121893')],
  '4641': [einnsynGeneric('Luster')],
  '4642': [einnsynGeneric('Årdal')],
  '4643': [einnsynGeneric('Lærdal')],
  '4644': [einnsynGeneric('Aurland')],
  '4645': [einnsynGeneric('Leikanger')],
  '4647': [einnsynGeneric('Balestrand')],
  '4648': [einnsynGeneric('Fjaler')],
  '4649': [einnsynGeneric('Gaular')],
  '4650': [einnsynGeneric('Jølster')],
  '4651': [einnsynGeneric('Gloppen')],
  '4652': [einnsynGeneric('Stryn')],
  '4653': [einnsynGeneric('Stad')],

  // ══════════════════════════════════════════════════════════════
  // MØRE OG ROMSDAL
  // ══════════════════════════════════════════════════════════════
  '1501': [einnsynGeneric('Vanylven')],
  '1505': [p360('Kristiansund', 'kristiansund')],
  '1506': [p360('Molde', 'molde')],
  '1507': [{
    kommune: 'Hustadvika', system: 'eInnsyn',
    url: 'https://einnsyn.no/sok',
    sokeUrl: (_gnr, _bnr, adresse) => `https://einnsyn.no/sok?q=${encodeURIComponent(`"${_gnr}/${_bnr}" ${adresse}`)}`,
  }],
  '1508': [elementsGnr('Ålesund', 'https://innsyn.alesund.kommune.no')],
  '1511': [einnsynGeneric('Sula')],
  '1514': [einnsynGeneric('Sande')],
  '1515': [elements('Herøy', 'https://prod01.elementscloud.no/publikum/872417982')],
  '1516': [einnsynGeneric('Ulstein')],
  '1517': [einnsynGeneric('Hareid')],
  '1519': [einnsynGeneric('Volda')],
  '1520': [einnsynGeneric('Ørsta')],
  '1525': [einnsynGeneric('Stranda')],
  '1528': [einnsynGeneric('Sykkylven')],
  '1531': [einnsynGeneric('Aukra')],
  '1535': [einnsynGeneric('Vestnes')],
  '1539': [einnsynGeneric('Rauma')],
  '1554': [einnsynGeneric('Averøy')],
  '1557': [einnsynGeneric('Gjemnes')],
  '1560': [einnsynGeneric('Tingvoll')],
  '1563': [p360('Sunndal', 'sunndal')],
  '1566': [einnsynGeneric('Surnadal')],
  '1573': [einnsynGeneric('Smøla')],
  '1576': [einnsynGeneric('Aure')],
  '1577': [einnsynGeneric('Hustadvika')],
  ...
  '3411': [einnsynGeneric('Ringsaker')],
  '3412': [einnsynGeneric('Nord-Odal')],
  '3413': [elements('Stange', 'https://prod02.elementscloud.no/publikum/970169717_PROD-970169717')],
  '3414': [einnsynGeneric('Stange')],
  '3415': [opengov('Sør-Odal', 'sor-odal')],
  '3416': [einnsynGeneric('Eidskog')],
  '3418': [einnsynGeneric('Grue')],
  '3419': [einnsynGeneric('Åsnes')],
  '3420': [einnsynGeneric('Elverum')],
  '3421': [einnsynGeneric('Stor-Elvdal')],
  '3422': [einnsynGeneric('Rendalen')],
  '3423': [einnsynGeneric('Engerdal')],
  '3424': [einnsynGeneric('Trysil')],
  '3425': [einnsynGeneric('Åmot')],
  '3426': [einnsynGeneric('Løten')],
  '3428': [einnsynGeneric('Alvdal')],
  '3430': [einnsynGeneric('Tynset')],
  '3431': [einnsynGeneric('Folldal')],
  '3432': [einnsynGeneric('Os')],
  '3434': [einnsynGeneric('Tolga')],
  '3436': [einnsynGeneric('Røros')],
  '3438': [einnsynGeneric('Holtålen')],
  '3440': [einnsynGeneric('Dovre')],
  '3441': [einnsynGeneric('Lesja')],
  '3442': [einnsynGeneric('Skjåk')],
  '3443': [elements('Vestre Toten', 'https://prod01.elementscloud.no/Publikum/971028300')],
  '3444': [einnsynGeneric('Vågå')],
  '3445': [einnsynGeneric('Lom')],
  '3446': [einnsynGeneric('Gran')],
  '3447': [elements('Lunner', 'https://prod01.elementscloud.no/publikum/934815483_PROD-934815483')],
  '3448': [einnsynGeneric('Jevnaker')],
  '3449': [einnsynGeneric('Nord-Aurdal')],
  '3450': [einnsynGeneric('Sør-Aurdal')],
  '3451': [einnsynGeneric('Etnedal')],
  '3452': [einnsynGeneric('Vestre Slidre')],
  '3453': [einnsynGeneric('Øystre Slidre')],
  '3454': [einnsynGeneric('Vang')],
  '3455': [einnsynGeneric('Ringebu')],
  '3456': [einnsynGeneric('Øyer')],
  '3457': [einnsynGeneric('Gausdal')],
  '3458': [einnsynGeneric('Nordre Land')],
  '3459': [einnsynGeneric('Søndre Land')],
  '3460': [einnsynGeneric('Nord-Fron')],
  '3461': [einnsynGeneric('Sel')],
  '3462': [einnsynGeneric('Sør-Fron')],
  '3463': [einnsynGeneric('Modum')],
  '3464': [einnsynGeneric('Sigdal')],
  '3465': [einnsynGeneric('Krødsherad')],
  '3466': [einnsynGeneric('Flå')],
  '3467': [einnsynGeneric('Nes')],
  '3468': [einnsynGeneric('Gol')],
  '3469': [einnsynGeneric('Hemsedal')],
  '3470': [einnsynGeneric('Ål')],
  '3471': [einnsynGeneric('Hol')],
  '3472': [einnsynGeneric('Nore og Uvdal')],
  '3473': [einnsynGeneric('Numedal')],
  '3474': [einnsynGeneric('Flesberg')],
  '3475': [einnsynGeneric('Rollag')],
  '3476': [einnsynGeneric('Kongsberg')],
  ...
  '5006': [elements('Steinkjer', 'https://prod01.elementscloud.no/publikum/921234554_PROD-921234554')],
  '5007': [elements('Namsos', 'https://prod01.elementscloud.no/publikum/942875967')],
  '5014': [einnsynGeneric('Frøya')],
  '5020': [einnsynGeneric('Osen')],
  '5022': [einnsynGeneric('Oppdal')],
  '5024': [einnsynGeneric('Rennebu')],
  '5025': [einnsynGeneric('Røros')],
  '5026': [einnsynGeneric('Holtålen')],
  '5027': [einnsynGeneric('Midtre Gauldal')],
  '5028': [elements('Melhus', 'https://prod01.elementscloud.no/publikum/938726027_PROD-938726027-MELHUS')],
  '5029': [einnsynGeneric('Skaun')],
  '5030': [einnsynGeneric('Orkland')],
  '5031': [einnsynGeneric('Malvik')],
  '5032': [einnsynGeneric('Selbu')],
  '5033': [einnsynGeneric('Tydal')],
  '5034': [einnsynGeneric('Meråker')],
  '5035': [elements('Stjørdal', 'https://prod01.elementscloud.no/publikum/963950373_PROD-963950373')],
  '5036': [einnsynGeneric('Frosta')],
  '5037': [einnsynGeneric('Levanger')],
  '5038': [elements('Verdal', 'https://prod01.elementscloud.no/publikum/938587418')],
  '5041': [einnsynGeneric('Snåsa')],
  '5042': [einnsynGeneric('Lierne')],
  '5043': [einnsynGeneric('Røyrvik')],
  '5044': [einnsynGeneric('Namsskogan')],
  '5045': [einnsynGeneric('Grong')],
  '5046': [einnsynGeneric('Høylandet')],
  '5047': [einnsynGeneric('Overhalla')],
  '5049': [einnsynGeneric('Nærøysund')],
  '5052': [einnsynGeneric('Vikna')],
  '5053': [einnsynGeneric('Leka')],
  '5054': [einnsynGeneric('Indre Fosen')],
  '5056': [einnsynGeneric('Heim')],
  '5057': [einnsynGeneric('Åfjord')],
  '5058': [einnsynGeneric('Flatanger')],
  '5059': [einnsynGeneric('Inderøy')],
  '5060': [einnsynGeneric('Hitra')],

  // ══════════════════════════════════════════════════════════════
  // NORDLAND
  // ══════════════════════════════════════════════════════════════
  '1804': [elementsGnr('Bodø', 'https://innsyn.bodo.kommune.no')],
  '1806': [elements('Narvik', 'https://prod02.elementscloud.no/publikum/963984917_PROD-963984917')],
  '1811': [einnsynGeneric('Bindal')],
  '1812': [einnsynGeneric('Sømna')],
  '1813': [einnsynGeneric('Brønnøy')],
  '1815': [einnsynGeneric('Vega')],
  '1816': [einnsynGeneric('Vevelstad')],
  '1818': [einnsynGeneric('Herøy')],
  '1820': [einnsynGeneric('Alstahaug')],
  '1822': [einnsynGeneric('Leirfjord')],
  '1824': [elements('Vefsn', 'https://prod01.elementscloud.no/publikum/844824122_PROD-844824122')],
  '1826': [einnsynGeneric('Hattfjelldal')],
  '1827': [einnsynGeneric('Grane')],
  '1832': [einnsynGeneric('Hemnes')],
  '1833': [elements('Rana', 'https://prod01.elementscloud.no/publikum/872418032_PROD-872418032')],
  '1836': [einnsynGeneric('Rødøy')],
  '1837': [einnsynGeneric('Meløy')],
  '1838': [einnsynGeneric('Gildeskål')],
  '1839': [einnsynGeneric('Beiarn')],
  '1840': [einnsynGeneric('Saltdal')],
  '1841': [einnsynGeneric('Fauske')],
  '1845': [einnsynGeneric('Sørfold')],
  '1848': [einnsynGeneric('Steigen')],
  '1851': [einnsynGeneric('Lødingen')],
  '1852': [einnsynGeneric('Tjeldsund')],
  '1853': [einnsynGeneric('Evenes')],
  '1856': [einnsynGeneric('Røst')],
  '1857': [einnsynGeneric('Værøy')],
  '1859': [einnsynGeneric('Flakstad')],
  '1860': [einnsynGeneric('Vestvågøy')],
  '1865': [einnsynGeneric('Vågan')],
  '1866': [einnsynGeneric('Hadsel')],
  '1867': [einnsynGeneric('Bø')],
  '1868': [einnsynGeneric('Øksnes')],
  '1870': [einnsynGeneric('Sortland')],
  '1871': [einnsynGeneric('Andøy')],
  '1874': [einnsynGeneric('Moskenes')],
  '1875': [einnsynGeneric('Hamarøy')],

  // ══════════════════════════════════════════════════════════════
  // TROMS (54xx – 2024-numre)
  // ══════════════════════════════════════════════════════════════
  '5401': [{
  ...
  '5404': [einnsynGeneric('Lenvik')],
  '5405': [einnsynGeneric('Tjeldsund')],
  '5406': [einnsynGeneric('Bardu')],
  '5407': [einnsynGeneric('Salangen')],
  '5408': [einnsynGeneric('Lavangen')],
  '5409': [einnsynGeneric('Storfjord')],
  '5410': [einnsynGeneric('Kåfjord')],
  '5411': [einnsynGeneric('Skjervøy')],
  '5412': [einnsynGeneric('Nordreisa')],
  '5413': [einnsynGeneric('Kvænangen')],
  '5414': [einnsynGeneric('Ibestad')],
  '5415': [einnsynGeneric('Gratangen')],
  '5417': [einnsynGeneric('Dyrøy')],
  '5418': [einnsynGeneric('Sørreisa')],
  '5420': [einnsynGeneric('Balsfjord')],
  '5421': [elements('Senja', 'https://prod02.elementscloud.no/publikum/920714486_PROD-920714486')],
  '5422': [einnsynGeneric('Karlsøy')],
  '5423': [einnsynGeneric('Lyngen')],
  '5425': [einnsynGeneric('Dyrøy')],
  '5426': [einnsynGeneric('Kvæfjord')],
  '5427': [einnsynGeneric('Torsken')],
  '5428': [einnsynGeneric('Berg')],
  '5430': [einnsynGeneric('Tranøy')],

  // ══════════════════════════════════════════════════════════════
  // FINNMARK (56xx – 2024-numre)
  // ══════════════════════════════════════════════════════════════
  '5601': [elements('Alta', 'https://prod02.elementscloud.no/publikum/944588132_PROD-944588132')],
  '5603': [einnsynGeneric('Hammerfest')],
  '5605': [einnsynGeneric('Hasvik')],
  '5607': [einnsynGeneric('Nordkapp')],
  '5611': [einnsynGeneric('Porsanger')],
  '5613': [einnsynGeneric('Karasjok')],
  '5614': [einnsynGeneric('Kautokeino')],
  '5615': [einnsynGeneric('Lebesby')],
  '5617': [einnsynGeneric('Gamvik')],
  '5619': [einnsynGeneric('Berlevåg')],
  '5620': [einnsynGeneric('Tana')],
  '5622': [einnsynGeneric('Nesseby')],
  '5623': [einnsynGeneric('Vadsø')],
  '5625': [einnsynGeneric('Vardø')],
  '5627': [einnsynGeneric('Sør-Varanger')],
}
