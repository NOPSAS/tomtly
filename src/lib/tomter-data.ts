...
export const ALLE_TOMTER: TomtListing[] = [
  ...
  {
    id: 'gamle-dalsveg-16', adresse: 'Gamle Dalsveg 16 A', poststed: 'Maura',
    kommune: 'Nannestad', areal_m2: 564, pris: 2300000, type: 'Eneboligtomt',
  ...
  },
  {
    ...
    poi: [
      ...
      { type: 'butikk', navn: 'Dagligvare', avstand: '7 min gange' },
      { type: 'natur', navn: 'Skog og turområder', avstand: '2 min gange' },
    ],
  },
]
